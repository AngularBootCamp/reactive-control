# DRAFT - Angular Boot Camp Curriculum - reactive-control
...
[StackBlitz for reactive-control](https://stackblitz.io/github/AngularBootCamp/reactive-control)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/reactive-control.git
cd reactive-control
yarn
yarn start
```
